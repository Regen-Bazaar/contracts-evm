...
/**
 * @title DeployCeloIndividual
 * @dev Deployment script for Celo Alfajores testnet with individual deployment and verification
 */
contract DeployCeloIndividual is DeploymentConfig {
    function run() public {
        initialize();
        
        console.log("=== Deploying to Celo Alfajores Testnet (Individual Deployment) ===");
        ...
        // Reset addresses to force new deployment
        rebazTokenAddress = address(0);
        impactNFTAddress = address(0);
        ...
        deployREBAZToken();
        deployImpactProductNFT();
        deployImpactProductStaking();
        deployMarketplace();
        deployFactory();
        ...
        console.log("=== Individual Deployment Complete ===");
        console.log("All contracts deployed and verified successfully!");
    }
    
    function deployREBAZToken() internal {
    ...
    function deployImpactProductNFT() internal {
    ...
    function deployImpactProductStaking() internal {
    ...
    function deployMarketplace() internal {
